...
public enum PacketBuilder {
    ...
    TEST(0), STATECHANGE(1), SHOP(2), SEARCHFORGAME(3), STARTGAME(4), LOGIN(5), SHOPINTERACTION(6), OPPONENT(7), STARTBATTLE(8), ROUNDCHECK(9), SIGNUP(10), BATTLEOUTCOME(11), GAMERESULTS(12);
